...
export const Moves: {[k: string]: ModdedMoveData} = {
	...
	*/
	...
	wistfulthinking: {
		...
		basePower: 0,
		category: "Status",
		desc: "Burns the opponent and switches out. Replacement heals 6.25% damage at the end of every turn until they leave the field.",
		shortDesc: "Burns foe, switches out. Replacement heals 1/16 on each turn.",
